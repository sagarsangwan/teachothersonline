    ...
    <Card className=" w-max-[400px]">
      <CardHeader>
        ...
        <CardDescription>
          <span>
            You have booked a{" "}
            <span className=" font-bold"> {demoClass.teachingMode}</span> demo
            class with us for {demoClass.subject} at{" "}
            {moment(demoClass.startTime)
              .local()
            ...
            {demoClass.Booked ? (
              demoClass.classlink ? (
                ...
                <span>
                  {" "}
                  your request fo demo class is accepted wait until our teacher
                  upload a link{" "}
                </span>
              )
            ) : (
              <span> wait till any of out teacher accept your request</span>
            )}
          </span>
        </CardDescription>
      </CardHeader>
