...
const DateTimePicker = React.forwardRef((props, ref) => {
    ...
    const [jsDatetime, setJsDatetime] = useState(props.jsDate || null);
    ...
    useEffect(() => {
        if (state.value) {
            ...
            setJsDatetime(date);
            props.onJsDateChange?.(date);
        }
    }, [state.value, props.onJsDateChange]);
    return (
        <div
            {...groupProps}
            ref={divRef}
        ...
        >
            ...
            <div className={cn('-ml-2 mr-2 h-5 w-5', !props.showClearButton && 'hidden')}>
                <X
