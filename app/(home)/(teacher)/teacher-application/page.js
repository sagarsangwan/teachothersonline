  ...
  const OnSubmit = async (data) => {
    ...
    try {
      const response = await fetch(
        "/api/teacher/teacher-form-submission",
        formData,
        {
          method: POST,
          headers: {
      ...
      if (res.status === 400) {
        toast.error(
          res.message ||
            "You have already submitted a teacher application go back to home page"
        );
        form.reset();
        router.push("/");
      }
    ...
    <div className="">
      <div>
        <div className="justify-center items-center flex flex-col py-7">
          <p>
            Hii ! We are excited to have you on board. Please fill the form
            below to apply as a teacher. We will get back to you soon.
          </p>
        </div>
        <Form {...form}>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (e.target.checked) {
                              ...
                              newValue.splice(
                                newValue.indexOf(subject.label),
                                1
                              );
                            }
